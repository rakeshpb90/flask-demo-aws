...
def commit_and_push_changes(repo, commit_message, file_path, branch_name):
...
new_branch = commit_and_push_changes(repo, commit_message, helm_values_path, branch_name)

# Create a pull request
pull_request_title = f"Update Helm values file with new image tag)"
pull_request_body = f"This pull request updates the Helm values file with the new image tag of the app"
